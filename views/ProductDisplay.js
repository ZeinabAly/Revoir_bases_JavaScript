...
export async function productDisplay(product) {
    ...
    return `<article class="card" data-product-id="${product.id}">
        ...
        <div class="mt-auto flex items-center justify-between pt-2">
            ...
            <button class="rounded-lg p-1.5 text-slate-400 hover:bg-slate-100 hover:text-slate-700" class="modifier" aria-label="Modifier" data-action="edit" data-product-id="${product.id}">
            ...
            <button class="rounded-lg p-1.5 text-slate-400 hover:bg-slate-100 hover:text-rose-500" class="supprimer" aria-label="Supprimer" data-action="delete" data-product-id="${product.id}">
